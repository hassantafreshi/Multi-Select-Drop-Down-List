...
function FunSearchTableEfb(dataSetId){
 ...
 document.addEventListener("click", (evnt) => {
     ...
     if(evnt.target.classList.contains('efblist')){
      ...
      const e =evnt.target.parentNode 
        if(e.classList.contains('efblist')){
            // اکر جدول کلیک شده در لیست یک منو باشد این بخش اجرا می شود
            ...
            if(l.dataset.no==1){
                ...
                if(e.dataset.row ==l.dataset.select){
                   ...
                   // fc.innerHTML=""; برای زمانی که مقدار قرار هست پاک شود مثل پرچم 
                ...
                //multiselect
                //بررسی می کند این ردیف انتخاب شده است یا نه
                // اگر انتخاب شده بود قبلا غیر فعال می شود و از لیست انتخاب ها حذف می شود
                // اگر انتخاب نشده بود ردیف انتخاب می شود و در لیست انتخاب ها قرار می گیرد
    ...
    //evnt.target.classList.contains('efbSelect')
 });
